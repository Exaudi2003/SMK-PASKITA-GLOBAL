        ...
        <div class="row">
            ...
            <div class="col-12 col-md-6 col-lg-5">
              <div class="card card-congratulation-medal">
                  <div class="card-body">
                      <h5>Halooo {{Auth::user()->name}}!</h5>
                      <p class="card-text font-small-3">Welcome Back</p>
                      <h3 class="mb-75 mt-4">
                          <a href="javascript:void(0);">Selamat Menunaikan Proses Belajar</a>
                      </h3>
                      <button type="button" class="btn btn-primary">Lihat Semua Event terkini</button>
                    ...
                    <div class="card-body">
                        ...
                        <div class="media">
                            ...
                            <div class="media-body">
                                ...
                                <small>JL. RAYA BOGOR KM. 25, CIJANTUNG, Kec. Pasar Rebo, Kota Jakarta Timur Prov. D.K.I. Jakarta </small>
                            </div>
                        </div>
