                                ...
                                <div class="col-6">
                                    <div class="form-group">
                                        ...
                                        <select name="pekerjaan_ayah" class="form-control">
                                            ...
                                            <option value="Buruh" {{old('pekerjaan_ayah') == 'Dokter' ? 'selected' : ''}}>Dokter</option>
                                            <option value="Buruh" {{old('pekerjaan_ayah') == 'PNS' ? 'selected' : ''}}>PNS</option>
                                        </select>
                                ...
                                <div class="col-6">
                                    <div class="form-group">
                                        ...
                                        <select name="pekerjaan_ibu" class="form-control">
                                            ...
                                            <option value="Buruh" {{old('pekerjaan_ibu') == 'Doker' ? 'selected' : ''}}>Dokter</option>
                                            <option value="Buruh" {{old('pekerjaan_ibu') == 'PNS' ? 'selected' : ''}}>PNSH</option>
                                        </select>
