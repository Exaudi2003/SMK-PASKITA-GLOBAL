                        ...
                        <div class="card-body">
                            ...
                            <div class="media">
                                ...
                                <div class="media-body">
                                    <h6 class="mb-0">{{ Carbon\Carbon::parse($event->acara ?? 0)->format('d F, Y') }}
                                    </h6>
                            ...
                            <div class="media">
                                ...
                                <div class="media-body">
                                    ...
                                    <small>JL. RAYA BOGOR KM. 25, CIJANTUNG, Kec. Pasar Rebo, Kota Jakarta Timur Prov.
                                        D.K.I. Jakarta </small>
                                </div>
                            </div>
