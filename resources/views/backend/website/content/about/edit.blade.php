                                                ...
                                                <div class="col-6">
                                                    <div class="form-group">
                                                        ...
                                                        <select name="is_active"
                                                            ...
                                                            <option value="0"
                                                                {{ $about->is_active == '0' ? 'selected' : '' }}>Aktif
                                                            </option>
                                                            <option value="1"
                                                                {{ $about->is_active == '1' ? 'selected' : '' }}>Tidak Aktif
                                                            </option>
                                                        </select>
                                                        @error('is_active')
                                                            <div class="invalid-feedback">
                                                ...
                                                <div class="col-12">
                                                    <div class="form-group">
                                                        <label for="basicInput">Description</label> <span
                                                            class="text-danger">*</span>
                                                        <textarea name="desc" class="form-control ckeditor  @error('desc') is-invalid @enderror" rows="5"> {!! old('desc', $about->desc) !!} </textarea>
                                                        @error('desc')
                                                            <div class="invalid-feedback">
                                                                <strong>{{ $message }}</strong>
                                                            </div>
