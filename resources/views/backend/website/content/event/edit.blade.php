            ...
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form action=" {{ route('backend-event.update', $event->id) }} " method="post"
                                ...
                                <div class="row">
                                    <div class="col-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control @error('title') is-invalid @enderror"
                                                name="title" value=" {{ $event->title }} " placeholder="Title Event" />
                                            @error('title')
                                    ...
                                    <div class="col-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control @error('lokasi') is-invalid @enderror"
                                                name="lokasi" value=" {{ $event->lokasi }} " placeholder="Lokasi Acara" />
                                            @error('lokasi')
                                                <div class="invalid-feedback">
                                                    <strong>{{ $message }}</strong>
                                                </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select name="is_Active"
                                                ...
                                                <option value="0" {{ $event->is_active == '0' ? 'selected' : '' }}>
                                                    Aktif</option>
                                                <option value="1" {{ $event->is_active == '1' ? 'selected' : '' }}>
                                                    Tidak Aktif</option>
                                            </select>
                                            @error('is_Active')
                                                <div class="invalid-feedback">
                                    ...
                                    <div class="col-12">
                                        <div class="form-group"> <span class="text-danger">*</span>
                                            <label for="basicInput">Desripsi Singkat</label> <span
                                                class="text-danger">*</span>
                                            <textarea name="desc" class="form-control ckeditor  @error('desc') is-invalid @enderror" rows="3"> {!! old('desc', $event->desc) !!} </textarea>
                                            @error('desc')
                                                <div class="invalid-feedback">
                                                    <strong>{{ $message }}</strong>
                                                </div>
                                    ...
                                    <div class="col-12">
                                        <div class="form-group"> <span class="text-danger">*</span>
                                            ...
                                            <textarea name="content" class="form-control ckeditor  @error('content') is-invalid @enderror" cols="30"
                                                rows="10">
