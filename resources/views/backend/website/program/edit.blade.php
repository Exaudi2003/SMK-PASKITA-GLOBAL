                                ...
                                <div class="row">
                                    ...
                                    <div class="col-3">
                                        <div class="form-group">
                                            ...
                                            <input type="text"
                                                ...
                                                name="singkatan" value=" {{ $jurusan->singkatan }} "
                                    ...
                                    <div class="col-3">
                                        <div class="form-group">
                                            ...
                                            <select name="is_active"
                                                ...
                                                <option value="0" {{ $jurusan->is_active == 0 ? 'selected' : '' }}>
                                                    Aktif</option>
                                                <option value="1" {{ $jurusan->is_active == 1 ? 'selected' : '' }}>
                                                    Tidak Aktif</option>
                                            </select>
                                            @error('is_active')
                                                <div class="invalid-feedback">
                                    ...
                                    <div class="col-12">
                                        <div class="form-group">
                                            ...
                                            <textarea name="content" class="form-control ckeditor  @error('content') is-invalid @enderror" cols="30" rows="10"> {!! old('content', $jurusan->dataJurusan->content) !!} </textarea>
                                            @error('content')
                                                <div class="invalid-feedback">
                                                    <strong>{{ $message }}</strong>
                                                </div>
