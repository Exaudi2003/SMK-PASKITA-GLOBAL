                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        @if ($profile == null)
                                            <form action=" {{ route('backend-profile-sekolah.store') }} " method="post"
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-12">
                                                        <div class="form-group">
                                                            <label for="basicInput">Content</label> <span
                                                                class="text-danger">*</span>
                                        ...
                                        @else
                                            <form action=" {{ route('backend-profile-sekolah.update', $profile->id) }} "
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-12">
                                                        <div class="form-group">
                                                            <label for="basicInput">Content</label> <span
                                                                class="text-danger">*</span>
                                                            <textarea name="content" class="form-control ckeditor  @error('content') is-invalid @enderror" rows="10">
