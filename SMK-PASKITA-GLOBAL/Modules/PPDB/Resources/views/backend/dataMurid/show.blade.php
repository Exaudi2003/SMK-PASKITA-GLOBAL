    ...
    <div class="content-header row">
        <div class="content-header-left col-md-9 col-12 mb-2">
            <div class="row breadcrumbs-top">
                <div class="col-12">
                    <h2>Form Pendaftaran PPDB SMK Paskita Global</h2>
                </div>
            </div>
        </div>
    </div>
                                ...
                                <div class="col-6">
                                    <div class="form-group">
                                        ...
                                        <select name="pekerjaan_ayah" class="form-control" disabled>
                                            ...
                                            <option value="Buruh" {{$murid->dataOrtu->pekerjaan_ayah == 'Dokter' ? 'selected' : ''}}>Dokter</option>
                                            <option value="Buruh" {{$murid->dataOrtu->pekerjaan_ayah == 'PNS' ? 'selected' : ''}}>PNS</option>
                                        </select>
                                ...
                                <div class="col-6">
                                    <div class="form-group">
                                        ...
                                        <select name="pekerjaan_ibu" class="form-control" disabled>
                                            ...
                                            <option value="Buruh" {{$murid->dataOrtu->pekerjaan_ibu == 'Dokter' ? 'selected' : ''}}>Dokter</option>
                                            <option value="Buruh" {{$murid->dataOrtu->pekerjaan_ibu == 'PNS' ? 'selected' : ''}}>PNS</option>
                                        </select>
